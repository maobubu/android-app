...
public class Zhongduan6 extends AppCompatActivity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case SendDateToServer.SEND_SUCCESS:
                    Toast.makeText(Zhongduan6.this, "发送成功", Toast.LENGTH_SHORT).show();
                    Log.d("发送成功","发送成功");
                    break;

                case SendDateToServer.SEND_FAIL:
                    Toast.makeText(Zhongduan6.this, "发送失败", Toast.LENGTH_SHORT).show();
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zhongduan6);
        ...
        final Intent Service=new Intent(this,MyService5.class);//服务
        intentFilter=new IntentFilter();
        intentFilter.addAction("com.example.broadcasttest5.MY_BROADCAST");//广播
        shujuReceiver=new MyBroadcastReceiver();
        registerReceiver(shujuReceiver,intentFilter);
        SharedPreferences share = getSharedPreferences("saveName6", 0);
    ...
    protected void onDestroy(){
        ...
        save(cunchu);//存储
        SharedPreferences sharedPreferences = getSharedPreferences("saveName6", Context.MODE_PRIVATE);
    ...
    public void save(String inputtext){
        ...
        try {
            out = openFileOutput("data6", Context.MODE_PRIVATE);
    ...
    class MyBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Toast.makeText(context, "终端六刷新完成", Toast.LENGTH_SHORT)
                    .show();
            if(msg!=null){
                cunchu=msg;
