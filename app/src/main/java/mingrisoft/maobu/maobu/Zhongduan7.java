...
public class Zhongduan7 extends AppCompatActivity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case SendDateToServer.SEND_SUCCESS:
                    Toast.makeText(Zhongduan7.this, "发送成功", Toast.LENGTH_SHORT).show();
                    Log.d("发送成功","发送成功");
                    break;

                case SendDateToServer.SEND_FAIL:
                    Toast.makeText(Zhongduan7.this, "发送失败", Toast.LENGTH_SHORT).show();
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zhongduan7);
        ...
        final Intent Service=new Intent(this,MyService6.class);//服务
        intentFilter=new IntentFilter();
        intentFilter.addAction("com.example.broadcasttest6.MY_BROADCAST");//广播
        shujuReceiver=new MyBroadcastReceiver();
        registerReceiver(shujuReceiver,intentFilter);
        SharedPreferences share = getSharedPreferences("saveName7", 0);
    ...
    protected void onDestroy(){
        ...
        save(cunchu);//存储
        SharedPreferences sharedPreferences = getSharedPreferences("saveName7", Context.MODE_PRIVATE);
    ...
    public void save(String inputtext){
        ...
        try {
            out = openFileOutput("data7", Context.MODE_PRIVATE);
    ...
    class MyBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Toast.makeText(context, "终端七刷新完成", Toast.LENGTH_SHORT)
                    .show();
            if(msg!=null){
                cunchu=msg;
