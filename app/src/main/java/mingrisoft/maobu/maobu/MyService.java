            ...
            switch (msg.what) {
                ...
                case SendDateToServer.GETVALUE:
                    if(xuanzhi==null) {
                        ...
                        xuanzhi1=xuanzhi;
                    Intent inta = new Intent("com.example.broadcasttest.MY_BROADCAST");
    ...
    public int onStartCommand(final Intent intent, int flags, int startId) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    if(xuanzhi==null){
                        Log.d("if","if");
                        new SendDateToServer(handler).SendDataToServer(Zhongduan1.id,xuanzhi1);
                    }else
                    new SendDateToServer(handler).SendDataToServer(Zhongduan1.id,xuanzhi);
